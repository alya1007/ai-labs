...
QUESTION_MAP = {
    ...
    'visits fast food places': "Does the tourist visit fast food places?",
    'smiles a lot': "Does the tourist smile a lot?",
    'is loud': "Is the tourist loud?",
    'visits local pubs': "Does the tourist visit local pubs?",
    ...
    'visits traditional restaurants': "Does the tourist visit traditional restaurants?",
